...
cd ~/ios/PlantainReader/PlantainReader

SCHEME_NAME="PlantainReader"
DATE=$(date +"%m%d_%H%M")
...
bundleVersion=`xcodebuild -showBuildSettings | grep MARKETING_VERSION | tr -d 'MARKETING_VERSION ='`
